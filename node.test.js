...
(function ($) {
    ...
    $.$mpds_cifplayer_scene = $mpds_cifplayer_scene;
})($ || ($ = {}));
//mpds/cifplayer/scene/-view.tree/scene.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($mpds_cifplayer_scene, {
            flex: {
                grow: 1
            }
        });
...
//mpds/cifplayer/scene/scene.view.css.ts
;
"use strict";
var $;
(function ($) {
